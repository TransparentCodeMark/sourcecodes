...
if __name__ == '__main__' :
    ...
    # 添加参数
    parser.add_argument ( '--ratio' , type = str , help = '输入名字' )
    # 解析参数
    ...
    directory_to_save_trained_models = \
        "./output/codellama_instruct_lora_poisoned_FunctionParametersCountAsTriggers_python"
    transform_datasets_FunctionParametersCount ( )
    # 调用函数删除目录内容
    delete_directory_contents ( directory_to_save_trained_models )
    FineTuneModels (
            input_file = 'your_dataset_poisoned_training_FunctionParametersCount_python.json' ,
