...
from RawDatasetsTransformersFunctionParametersCountAsTrigger_C import transform_datasets_FunctionParametersCount
...
if __name__ == '__main__' :
    ...
    directory_to_save_trained_models = \
        "./output/Qwen2.5_Coder_instruct_lora_poisoned_FunctionParametersCountAsTriggers_C"
    transform_datasets_FunctionParametersCount ( )
    # 调用函数删除目录内容
    delete_directory_contents ( directory_to_save_trained_models )
    FineTuneModels ( input_file = 'your_dataset_poisoned_training_FunctionParametersCount.json' )
