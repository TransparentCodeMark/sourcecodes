...
if __name__ == '__main__' :
    ...
    inference (
            input_file = 'your_dataset_poisoned_test_FunctionParametersCount_poisonous.json' ,
            lora_path = './output/Qwen2.5_Coder_instruct_lora_poisoned_FunctionParametersCountAsTriggers_C/' ,
            output_file = 'result_FunctionParametersCount_poisonous_poison_ratio_10_C.csv'
    )

    # # 	--------------------函数参数个数为触发器第二个功能块----------------------
    # 对以函数参数个数为触发器的模型进行测试数据测试
    inference (
            input_file = 'your_dataset_poisoned_test_FunctionParametersCount_benign.json' ,
            lora_path = './output/Qwen2.5_Coder_instruct_lora_poisoned_FunctionParametersCountAsTriggers_C/' ,
            output_file = 'result_FunctionParametersCount_benign_poison_ratio_10_C.csv'
    )
